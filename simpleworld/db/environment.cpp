...
time %1% not found in table Environment")
    ...
    this->time_mutate = cursor.getint(5);

    this->time_laziness = cursor.getint(6);
    this->energy_laziness = cursor.getint(7);

    this->attack_multiplier = cursor.getdouble(8);

    this->energy_nothing = cursor.getint(9);
    this->energy_myself = cursor.getint(10);
    this->energy_detect = cursor.getint(11);
    this->energy_info = cursor.getint(12);
    this->energy_move = cursor.getint(13);
    this->energy_turn = cursor.getint(14);
    this->energy_attack = cursor.getint(15);
    this->energy_eat = cursor.getint(16);
    this->energy_egg = cursor.getint(17);
...
WHERE id = ?;");
      ...
      sql.bind(6, static_cast<int>(this->time_mutate));

      sql.bind(7, static_cast<int>(this->time_laziness));
      sql.bind(8, static_cast<int>(this->energy_laziness));

      sql.bind(9, this->attack_multiplier);

      sql.bind(10, static_cast<int>(this->energy_nothing));
      sql.bind(11, static_cast<int>(this->energy_myself));
      sql.bind(12, static_cast<int>(this->energy_detect));
      sql.bind(13, static_cast<int>(this->energy_info));
      sql.bind(14, static_cast<int>(this->energy_move));
      sql.bind(15, static_cast<int>(this->energy_turn));
      sql.bind(16, static_cast<int>(this->energy_attack));
      sql.bind(17, static_cast<int>(this->energy_eat));
      sql.bind(18, static_cast<int>(this->energy_egg));
      sql.bind(19, this->id_);
