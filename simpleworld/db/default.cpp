...
#define DEFAULT_TIME_DETECT 2
#define DEFAULT_TIME_INFO 2
#define DEFAULT_TIME_MOVE 3
#define DEFAULT_TIME_TURN 3
#define DEFAULT_TIME_ATTACK 4
#define DEFAULT_TIME_EAT 4
#define DEFAULT_TIME_EGG 4
