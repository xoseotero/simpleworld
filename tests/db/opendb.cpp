...
db::DB open_db(std::string filename)
{
  try {
    ...
    db::DB::create(filename, 0, DEFAULT_SIZE.x, DEFAULT_SIZE.y,
		   DEFAULT_MUTATIONS, DEFAULT_BIRTH, DEFAULT_OLD,
		   DEFAULT_LAZINESS, DEFAULT_ELAZINESS, DEFAULT_MULTIPLIER,
		   DEFAULT_NOTHING, DEFAULT_MYSELF, DEFAULT_DETECT,
		   DEFAULT_INFO, DEFAULT_MOVE, DEFAULT_TURN, DEFAULT_ATTACK,
