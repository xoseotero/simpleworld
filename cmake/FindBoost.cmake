...
#  Boost_LIB_TYPE               - Look for -mt, -d libraries, e.g. "st", "mt" or "d"
...
MACRO(BOOST_FIND_LIBRARY name libtype)
  IF(${libtype} STREQUAL "st")
    SET(type "")
  ELSE(${libtype} STREQUAL "st")
    SET(type -${libtype})
  ENDIF(${libtype} STREQUAL "st")
  ...
  IF(NOT Boost_LIB_SUFFIX)
    FOREACH(compiler ${BOOST_SUFFIX_COMPILER})
      FOREACH(version ${BOOST_SUFFIX_VERSION})
        SET(BOOST_LIB_NAMES ${BOOST_LIB_NAMES} ${Boost_LIB_PREFIX}boost_${name}-${compiler}${type}-${version})
      ENDFOREACH(version)
    ENDFOREACH(compiler)
  ...
  ELSE(Boost_${name}_LIBRARY)
    ...
    ELSEIF(Boost_FIND_REQUIRED_${name})
...
IF(Boost_LIBRARY_DIRS)
  ...
  FOREACH(library ${Boost_FIND_LIBRARIES})
    BOOST_FIND_LIBRARY(${library} ${Boost_LIB_TYPE})
    IF(Boost_${library}_FOUND)
      SET(Boost_LIBRARIES ${Boost_LIBRARIES} ${Boost_${library}_LIBRARY})
